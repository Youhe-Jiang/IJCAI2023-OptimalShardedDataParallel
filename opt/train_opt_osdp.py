...
from osdp_utils.opt_osdp_model import opt_osdp_model
...
def train(args):
    ...
    # Initializing a OPT facebook/opt-30b style configuration
    ...
    # OSDP implementation
    model = opt_osdp_model(model, configuration.hidden_size, 4)
